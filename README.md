...
Automatically scroll through the active note at a configurable speed. Useful for reading long documents hands-free or during presentations.

https://user-images.githubusercontent.com/15689774/203650814-d8bd8164-c4c5-46cd-8cfe-8207f24ff9aa.mp4

## Features

- Toggle autoscroll with a command or ribbon icon
...
2. Run **Autoscroll: Toggle scrolling** or click the ribbon icon.
3. Use **Increase speed** and **Decrease speed** commands to adjust the rate.

## Known issues

- Autoscroll stops if you activate it before focusing a note's content.
